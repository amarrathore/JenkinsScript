...
public class ScriptForJenkins2 extends WebDriverFactory {
	...
	public void home() throws Exception {
		try {
			Thread.sleep(8000);
			driver.findElement(By.cssSelector(".active.liblock.liblockfirst>a")).click();;		
	...
	public void PAXInfo() {
		try {
			...
			String expectedText = driver.findElement(By.className("content-h")).getText();
			...
			driver.findElement(By.cssSelector("button#submit_passenger_button")).click();
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	}
	...
	public void selectSeat() {
		try {
			...
			Thread.sleep(10000);
			driver.findElement(By.cssSelector("button#js-next-seatmap-button")).click();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void carAndPayment() throws InterruptedException {
		try {
			Thread.sleep(5000);
			driver.findElement(By.xpath("//button[contains(@class,'button-footer')]")).click();
			Thread.sleep(3000);
			driver.findElement(By.cssSelector("button[type='button']")).click();
			String paymentText = "Select your payment method";
			String expectedText = driver.findElement(By.cssSelector(".content-wrapper.cars-section>a>h1")).getText();
