...
public class ScriptForJenkins3 extends WebDriverFactory {
	...
	public void home() throws Exception {
		try {
			...
			//Thread.sleep(3000);
			/*driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
			WebElement sourcre = driver.findElement(By.linkText("Cancun"));
			((JavascriptExecutor) driver).executeScript("window.scrollTo(0,"+sourcre.getLocation().y+")");
		    // Click the element
			sourcre.click();*/
	...
	public void selectDate() {
		try {
			Thread.sleep(3000);
			//wait = new FluentWait<WebDriver>(driver).withTimeout(30, TimeUnit.SECONDS).pollingEvery(10, TimeUnit.SECONDS).ignoring(NoSuchElementException.class);
			 driver.findElement(By.id("btnPassenger")).click();			
			//executor.executeScript("document.getElementById('btnPassenger').click();");
			//selectDate.click();
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
